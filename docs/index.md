...
- **Sparky production operations** → [Sparky Operations](OPERATIONS_SPARKY.md)
...
- **v0.6 post-mission production cutover cleanup** → [Post-Mission Cutover Cleanup](SPEC_POST_MISSION_CUTOVER_CLEANUP.md)
